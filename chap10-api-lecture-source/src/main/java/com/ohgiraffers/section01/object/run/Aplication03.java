...
public class Aplication03 {
    public static void main(String[] args) {
        ...
        * 같은 해시코드 값을 가져야 한다는 규약에 위반되게 된다. (강제성은 없지만 규약대로 작성하는것이 좋다)
        * */

        Book bk1 = new Book(1, "홍길동전", "허균", 50000);
        Book bk2 = new Book(1, "홍길동전", "허균", 50000);

        System.out.println("book1의 hashCode: " + bk1.hashCode());
        System.out.println("book2의 hashCode: " + bk2.hashCode());
    }
}
