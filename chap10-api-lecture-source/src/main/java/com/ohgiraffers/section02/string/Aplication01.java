...
public class Aplication01 {
    public static void main(String[] args) {
        ...
        /* charAt(): 헤당 문자열의 특정 인덱스에 해당하는 문자를 반환한다.
        ...
        * */
        ...
        System.out.println("substring(3,6) : " + javamysql.substring(3));


        /* replace() : 문자열애서 대체할 문자열로 기존 문자열을 변경해서 반환한다. */
        System.out.println();
        System.out.println("================= replace() ===================");
        System.out.println("replace() : " + javamysql.replace("java","python"));


        /* length() : 문자열의 길이를 정수혀으로 반환한다. */
        System.out.println();
        ...
        * */
        ...
        System.out.println("isEmpty() : " + "abcs".isEmpty());
        
        /*boolean, char는 빈값 넣지 못함*/
    }
}
