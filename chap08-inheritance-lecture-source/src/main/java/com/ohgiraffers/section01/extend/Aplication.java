...
public class Aplication {
    public static void main(String[] args) {
         ...
         * 특히 메소드 재정의(overridng)라는 기술을 이용해 부모가 가진 메소드를 재정의 하는것도 가능하다.
         *
         * [메소드 재정의(overriding)]
         * 부모가 가지는 메소드 선언부를 그대로 사용하면서
         * 자식클래스가 정의한 메소드대로 동작하도록 메소드 동작(구현 몸체) 부분을 새롭게 다시 작성하는 기술이다.
         ...
         * 상속은 IS-A(한 객체가 다른 객체의 하위 관계) 관계로 구분되는 경우에만 사용해야 한다.
         *
         * */
