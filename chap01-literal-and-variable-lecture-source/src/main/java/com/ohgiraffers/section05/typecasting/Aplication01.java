...
public class Aplication01 {
    public static void main(String[] args) {
        ...
        **/
        ...
        /*필기. 점점 더 큰 자료형으로는 데이터를 옮겨도 문제 없이 자동 형변환 처리 된다.*/
        byte bnum = 1;
        short snum = bnum;
        int inum = snum;
        long lnum = inum;
        ...
        int num1=10;
        long num2=20;
//        int result1 = num1+num2; //자동으로 큰 쪽 자료형인 long으로 변경 후 계산하기 때문에 int형 변수에 담을수 없음
        long result1 = num1+num2; //int + long은 서로 다른 자료형이라 데이터 손실이 발생하지 않는 int->long 변환을 자동 수행후 연산한다.
        ...
        * 문자형은 int형으로 자동 형변환 된다.*/
        ...
        /*논리형은 다른 타입에 담을수 없음(형변환 규칙에서 제외)*/
//        boolean isTrue = true;
//        byte b = isTrue;
//        int i = isTrue;
//        char c =isTrue;
