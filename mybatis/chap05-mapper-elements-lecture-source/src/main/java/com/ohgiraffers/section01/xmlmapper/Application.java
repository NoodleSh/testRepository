...
public class Application {
    public static void main(String[] args) {
        ...
        do{
            ...
            switch (no){
                case 1: elementTestService.selectCacheTest();
                    break;
                case 2: resultMapSubMenu();
                    break;
                case 3: elementTestService.selectSqlTest();
                    break;
                case 4: elementTestService.insertCategoryAndMenuTest(inputMenuAdnCategory());
                    break;
    ...
    private static MenuAndCategoryDTO inputMenuAdnCategory() {
        Scanner sc = new Scanner(System.in);
