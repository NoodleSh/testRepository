...
public class User {
    ...
    * 2. 매개변수가 있는 생성자의 경우 매개변수로 전달받은 값으로 필드를 초기화하며, 인스턴스를 생성할 목적으로 주로 사용한다.
    ...
    *       this.필드명 = 매개변수; //설정자(setter) 여러 개의 기능을 한번의 호출로 수헹 가능
    * }
    *
    * 생성자 작성 시 주의할 점
...
//    }
    ...
    public User(String id, String pwd, String name){
        ...
        System.out.println("User 클래스의 id, pwd, name을 초기화하는 생성하 호출함");
    }
