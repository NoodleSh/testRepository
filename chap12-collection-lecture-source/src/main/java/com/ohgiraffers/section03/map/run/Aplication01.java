...
public class Aplication01 {
    public static void main(String[] args) {
        ...
        * 키(key) 와 값(value)를 하나의 쌍으로 지정하는 방식을 사용한다.
        *
        * 키(key)란?
        ...
        * */
        ...
        /* 키는 중복 저장 되지 않음(set) : 최근 키로 overried됨(덮어씀) */
        ...
        System.out.println("키 9에 다한 객체 : " + hmap.get(9));
        ...
        while((ketIter.hasNext())) {
            ...
            String value = hmap2.get(key); // key값에 해당하는 value를 가져옴
...
//        Iterator<String> valueIter = hmap2.values().iterator();
        ...
        *
        * [entrySet() : Map에 저장된 모든 키-값 쌍(Entry)을 Set형태로 반환한다]
        * getKey()와 getValue()메소드를 제공하여 키와 값을 각각 가져올 수 있다.
        *
        * Map.Entry 객체는 하나의 키와 값에 대한 참조를 제공하며, 이를 통해 특정 Map 항목의 키or값을 가져오거나 설정할 수 있다. */

        /* entrySet : Map에 있는 key값과 value값을 Set형태로 반환해줌 */
         Iterator<Map.Entry<String,String>>entryItr = hmap2.entrySet().iterator();

//         Set<Map.Entry<String, String>> set = hmap2.entrySet();
//         Iterator<Map.Entry<String,String>> entryItr = set.iterator();
