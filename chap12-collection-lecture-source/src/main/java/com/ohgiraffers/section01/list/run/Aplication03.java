...
public class Aplication03 {
    public static void main(String[] args) {
        ...
        * 이를 보완하고자 만든 것이 이중연결 리스트이다.
        *
        * 이중 연결 리스트
        * 단일 연결 리스트는 다음 요소만 링크하는 반면 이중 연결 리스트는 이전 요소도 링크하여
        * 이전 요소로 접급하기 쉽게 고안된 자료구조이다.
        * */
        ...
        System.out.println("linkedList 사이즈 : " + linkedList.size());
        ...
        System.out.println("---------------------------------");
        System.out.println(linkedList.isEmpty()); // isEmpty() : 비었는지 확인하는 메소드

        System.out.println("---------------------------------");
        linkedList.clear(); // 리스트안에 있는 내용을 모두 제거
