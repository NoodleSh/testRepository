...
public class Application04 {
    public static void main(String[] args) {
        ...
        * */
        ...
        try {
            objOut = new ObjectOutputStream(new BufferedOutputStream(new FileOutputStream("src/main/java/com/ohgiraffers/section03/filterstre/testObjStream.txt")));
        ...
        /* DTO에 직렬화 처리를 하지 않았다면, 실행할 때 NotSerializableException이 발생할 것이다. */
        ...
        try {
            objIn = new ObjectInputStream(new BufferedInputStream(new FileInputStream("src/main/java/com/ohgiraffers/section03/filterstre/testObjStream.txt")));
            while(true) {
